...
for movie in top_250_with_info:
    cursor.execute("INSERT INTO movies (id, localized_title, runtime, rating, year) VALUES (?,?,?,?,?)",
                   (movie['imdbID'], movie['localized title'], movie['runtimes'][0], movie['rating'], movie['year']))
